...
# example usage: python vcf2smartpca.py 0.5.vcf fufu1 0 popfile_for_pca.txt
...
#    print headers, snp_gens, pops, contigs, pos
...
#            if ['.', '.'] not in locus and locus != []: ORIGINAL
            if locus != []: # MATHIAS version: allow missing data!
